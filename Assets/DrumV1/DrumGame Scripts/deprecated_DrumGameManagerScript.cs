...
public class deprecated_DrumGameManagerScript : MonoBehaviour
{
    enum SongParts
    {
        Intro,
    ...
    public static deprecated_DrumGameManagerScript instance;
    ...
    {
        DespawnGhosts();
        KickDrum.GetComponent<deprecated_DrumSpawnerScript>().DrumPattern = KickPatterns[SongStructure[currentPart]];
        SnareDrum.GetComponent<deprecated_DrumSpawnerScript>().DrumPattern = SnarePatterns[SongStructure[currentPart]];
        HiHat.GetComponent<deprecated_DrumSpawnerScript>().DrumPattern = HiHatPatterns[SongStructure[currentPart]];
        KickDrum.GetComponent<deprecated_DrumSpawnerScript>().SpawnAroundPoint(kickRadius);
        SnareDrum.GetComponent<deprecated_DrumSpawnerScript>().SpawnAroundPoint(snareRadius);
        HiHat.GetComponent<deprecated_DrumSpawnerScript>().SpawnAroundPoint(hiHatRadius);
    }

    public void SpawnGhosts()
    {
        KickGhost.GetComponent<deprecated_DrumSpawnerScript>().DrumPattern = KickPatterns[SongStructure[currentPart]];
        SnareGhost.GetComponent<deprecated_DrumSpawnerScript>().DrumPattern = SnarePatterns[SongStructure[currentPart]];
        HiHatGhost.GetComponent<deprecated_DrumSpawnerScript>().DrumPattern = HiHatPatterns[SongStructure[currentPart]];
        KickGhost.GetComponent<deprecated_DrumSpawnerScript>().SpawnAroundPoint(kickRadius);
        SnareGhost.GetComponent<deprecated_DrumSpawnerScript>().SpawnAroundPoint(snareRadius);
        HiHatGhost.GetComponent<deprecated_DrumSpawnerScript>().SpawnAroundPoint(hiHatRadius);

    }

    public void Despawn()
    {
        KickDrum.GetComponent<deprecated_DrumSpawnerScript>().DeleteDrums();
        SnareDrum.GetComponent<deprecated_DrumSpawnerScript>().DeleteDrums();
        HiHat.GetComponent<deprecated_DrumSpawnerScript>().DeleteDrums();
    }
    public void DespawnGhosts()
    {
        KickGhost.GetComponent<deprecated_DrumSpawnerScript>().DeleteDrums();
        SnareGhost.GetComponent<deprecated_DrumSpawnerScript>().DeleteDrums();
        HiHatGhost.GetComponent<deprecated_DrumSpawnerScript>().DeleteDrums();
